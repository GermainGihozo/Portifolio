...
const HorizontalPortfolio = () => {
  ...
  return (
    <div
      className={`h-screen w-full ${theme.bg} ${theme.text} overflow-hidden`}
    >
      ...
      <div
        className={`h-full ${
          isMobile ? "pt-28" : "ml-64"
        } overflow-x-auto overflow-y-hidden snap-x snap-mandatory`}
      >
        <div className="h-full w-[500vw] flex">
          {/* Home Section */}
          <section
            id="home"
            className={`h-full w-screen flex-shrink-0 snap-start flex items-center justify-center px-6 md:px-16 ${theme.bg}`}
          >
            <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-16 items-center">
              ...
              <motion.div
                ...
                className="flex justify-center order-first lg:order-last mb-6 lg:mb-0"
              >
                <div
          ...
          <section
            id="about"
            className={`h-full w-screen flex-shrink-0 snap-start flex items-center justify-center px-6 md:px-16 ${
              ...
              <div className="flex flex-col md:flex-row items-center">
                ...
                <div className="w-full md:w-2/3 mt-8 md:mt-0 md:pl-8 lg:pl-16">
                  ...
                  >
                    ...
                    >
                      With expertise across the full stack, I bring ideas to
                      life through modern web technologies while ensuring
          ...
          <section
            id="skills"
            className="h-full w-screen flex-shrink-0 snap-start flex items-center px-4 md:px-8 py-8 md:py-12"
          >
            <div className="max-w-6xl mx-auto w-full h-full overflow-y-hidden">
              <motion.div
                initial={{ opacity: 0 }}
                whileInView={{ opacity: 1 }}
                transition={{ duration: 0.8 }}
                viewport={{ once: true }}
                className="text-center mb-6 md:mb-8 sticky top-0 pt-2 pb-4 md:pt-4 md:pb-6 z-10 bg-opacity-90 backdrop-blur-sm"
                style={{
              ...
              >
                ...
                <div
                  className={`w-20 h-1 mx-auto mt-3 md:mt-4 ${
                    darkMode ? "bg-emerald-400" : "bg-emerald-600"
                  }`}
                ></div>
              </motion.div>
          ...
          <section
            id="projects"
            className={`h-full w-full flex-shrink-0 snap-start flex items-center justify-center px-4 md:px-8 py-8 md:py-12 overflow-y-auto ${
              darkMode ? "bg-stone-800" : "bg-stone-100"
            } transition-colors duration-300`}
          >
                ...
                >
                  ...
                  <div className="p-4 md:p-6">
                    ...
                    <p
                      className={`text-xs md:text-sm mb-3 md:mb-4 ${theme.secondary}`}
                    >
                      A modern portfolio showcasing skills and projects with
                      unique aesthetics and seamless UX.
                    </p>
                    <div className="flex flex-wrap gap-1 md:gap-2">
          ...
          <section
            id="contact"
            className={`h-full w-screen flex-shrink-0 snap-start flex items-center justify-center px-4 md:px-8 py-8 md:py-12 ${theme.bg}`}
          >
